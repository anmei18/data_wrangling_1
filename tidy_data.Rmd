...
Merge Litters dataset into the pups dataset
Litter_number is the key because its the variable that exists in both dataset

We want to have one variable in each column
In `litters_df`, group column consist of three kinds of dosage: con, mod and low, and two different day of treatment: 7 and 8.
```{r}
litters_df = 
